...
from ml.text_summarization.summarization import summarize_text  # Replace with actual import path
...
classification_model_pkl = pickle.load(open("artifacts/model.pkl", "rb"))  # Ensure path is correct
...
def summarize_feedback(feedback_list):
    ...
    return summarize_text(combined_feedback)  # Implement your summarization logic
...
def analyze_feedback():
    ...
    print("Other_feedback    : ", other_feedback)
    ...
    print("Other_summary    : ", other_summary)
